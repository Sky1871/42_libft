...
- [ft_strlcpy](/ft_strlcopy.c): size bounded string copying
- [ft_strlcat](/ft_strlcat.c): size bounded string concatention
...
- [ft_ftoa_rnd](/ft_ftoa_rnd): convert float to ASCII string
...
- [ft_lstmap](/ft_lstmap.c): apply functions to content of all list's elements into a new list
